...
Tags: woocommerce, checkout, fees, payment processing
...
A voluntary checkout checkbox letting customers cover the card processing fee, grossed up so the full amount arrives.

== Description ==

See the README on GitHub for the full description, requirements, and known
limitations: https://github.com/biscuitstudios/woo-cover-processing-fee
...
= 1.3.0 =
See https://github.com/biscuitstudios/woo-cover-processing-fee/releases
